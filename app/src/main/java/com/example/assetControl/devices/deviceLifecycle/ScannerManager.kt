package com.example.assetControl.devices.deviceLifecycle
...
import com.example.assetControl.devices.scanners.Collector.Companion.collectorTypeChanged
import com.example.assetControl.devices.scanners.Collector.Companion.isNfcRequired
import com.example.assetControl.devices.scanners.Scanner
import com.example.assetControl.devices.scanners.Scanner.ScannerListener
import com.example.assetControl.devices.scanners.collector.CollectorType
import com.example.assetControl.devices.scanners.floatingCamera.FloatingCameraBarcode
import com.example.assetControl.devices.scanners.nfc.Nfc
import com.example.assetControl.devices.scanners.nfc.Nfc.enableNfcForegroundDispatch
...
object ScannerManager : DeviceLifecycle.Listener {
     ...
     * LifecycleOwner com.example.assetcontrol.xxx.xxxActivity@cf72429
