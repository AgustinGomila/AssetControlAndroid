package com.example.assetControl.devices.scanners.zebra
...
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.ACTION_RESULT_NOTIFICATION
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_CREATE_PROFILE
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_EMPTY
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_GET_VERSION_INFO
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_APPLICATION_NAME
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_NOTIFICATION_TYPE
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_SCANNER_STATUS
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_PROFILENAME
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_REGISTER_NOTIFICATION
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SEND_RESULT
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SET_CONFIG
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SOFT_SCAN_TRIGGER
import com.example.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_UNREGISTER_NOTIFICATION
...
class Zebra(private val activity: AppCompatActivity) : Scanner() {
    ...
    private fun initializeScanner() {
        ...
        // Set Symbologies
        barcodeProps.putString("decoder_pdf417", svm.symbologyPDF417.toString())
        barcodeProps.putString("decoder_aztec", svm.symbologyAztec.toString())
        barcodeProps.putString("decoder_qrcode", svm.symbologyQRCode.toString())
        barcodeProps.putString("decoder_codabar", svm.symbologyCODABAR.toString())
        barcodeProps.putString("decoder_code128", svm.symbologyCode128.toString())
        barcodeProps.putString("decoder_code39", svm.symbologyCode39.toString())
        barcodeProps.putString("decoder_code93", svm.symbologyCode93.toString())
        barcodeProps.putString("decoder_datamatrix", svm.symbologyDataMatrix.toString())
        barcodeProps.putString("decoder_ean13", svm.symbologyEAN13.toString())
        barcodeProps.putString("decoder_ean8", svm.symbologyEAN8.toString())
        barcodeProps.putString("decoder_maxicode", svm.symbologyMaxiCode.toString())
        barcodeProps.putString("decoder_upca", svm.symbologyUPCA.toString())
        barcodeProps.putString("decoder_upce0", svm.symbologyUPCE.toString())
