package com.example.assetControl.data.room.entity.attribute
...
@Entity(
    tableName = AttributeCompositionEntry.TABLE_NAME,
    indices = [
        Index(
            value = [AttributeCompositionEntry.ATTRIBUTE_ID],
            name = "IDX_${AttributeCompositionEntry.TABLE_NAME}_${AttributeCompositionEntry.ATTRIBUTE_ID}"
        ),
        Index(
            value = [AttributeCompositionEntry.ATTRIBUTE_COMPOSITION_TYPE_ID],
            name = "IDX_${AttributeCompositionEntry.TABLE_NAME}_${AttributeCompositionEntry.ATTRIBUTE_COMPOSITION_TYPE_ID}"
        ),
        Index(
            value = [AttributeCompositionEntry.DESCRIPTION],
            name = "IDX_${AttributeCompositionEntry.TABLE_NAME}_${AttributeCompositionEntry.DESCRIPTION}"
        )
    ]
)
