...
@Entity(
    tableName = AttributeEntry.TABLE_NAME,
    indices = [
        Index(
            value = [AttributeEntry.ATTRIBUTE_TYPE_ID],
            name = "IDX_${AttributeEntry.TABLE_NAME}_${AttributeEntry.ATTRIBUTE_TYPE_ID}"
        ),
        Index(
            value = [AttributeEntry.ATTRIBUTE_CATEGORY_ID],
            name = "IDX_${AttributeEntry.TABLE_NAME}_${AttributeEntry.ATTRIBUTE_CATEGORY_ID}"
        ),
        Index(
            value = [AttributeEntry.DESCRIPTION],
            name = "IDX_${AttributeEntry.TABLE_NAME}_${AttributeEntry.DESCRIPTION}"
        )
    ]
)
