    ...
    fun getField(): ArrayList<BarcodeLabelField> {
        ...
        if (asset != null) {
            ...
            Collections.addAll(
                ...
                BarcodeLabelField(DefinedField.EAN, asset.ean.orEmpty()),
                ...
                BarcodeLabelField(DefinedField.MANUFACTURER, asset.manufacturer.orEmpty(), 15),
                BarcodeLabelField(DefinedField.MODEL, asset.model.orEmpty(), 15),
                BarcodeLabelField(DefinedField.SERIAL_NUMBER, asset.serialNumber.orEmpty()),
