...
import com.example.assetControl.data.room.dao.dataCollection.DataCollectionDao
...
import com.example.assetControl.data.room.dao.maintenance.AssetMaintenanceDao
...
import com.example.assetControl.data.room.dao.movement.WarehouseMovementDao
...
import com.example.assetControl.data.room.dao.route.RouteProcessDao
...
import com.example.assetControl.data.room.database.AcDatabase.Companion.DATABASE_VERSION
...
import com.example.assetControl.data.room.entity.dataCollection.DataCollectionEntity
import com.example.assetControl.data.room.entity.dataCollection.DataCollectionRuleContentEntity
import com.example.assetControl.data.room.entity.dataCollection.DataCollectionRuleEntity
...
import com.example.assetControl.data.room.entity.movement.WarehouseMovementEntity
import com.example.assetControl.data.room.entity.review.AssetReviewContentEntity
...
import com.example.assetControl.data.room.entity.route.RouteProcessEntity
...
import com.example.assetControl.data.room.entity.user.UserEntity
...
abstract class AcDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private const val IDENTITY_HASH_V1 = "8c339dcaa4d8d98d9e036eacdc162860"
