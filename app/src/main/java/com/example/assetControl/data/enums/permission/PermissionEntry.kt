package com.example.assetControl.data.enums.permission
...
class PermissionEntry(
    ...
    companion object {
        ...
        private var DeskMenuAssetMaintenanceProgramed = PermissionEntry(
            54,
        ...
        private var SeeAllRepairshop = PermissionEntry(
            ...
            PermissionCategory.AssetMaintenance
        )
        private var AddAssetMaintenance = PermissionEntry(
            151,
            "Mantenimiento programado, agregar",
            PermissionCategory.AssetMaintenance
        )
        private var AddMaintenanceTypeGroup = PermissionEntry(
            152,
            "Grupo de tareas, agregar",
            PermissionCategory.AssetMaintenance
        )
        private var ModifyMaintenanceTypeGroup = PermissionEntry(
            153,
        ...
        private var ModifyAssetMaintenance = PermissionEntry(
            157,
        ...
        var CollButtonAssetMaintenance = PermissionEntry(
            210,
        ...
        ////////////// MENU ASSET MAINTENANCE
        private var DeskMenuInOut = PermissionEntry(
            300,
            "Menú, entradas / salidas",
            PermissionCategory.DeskMenuAssetMaintenance
        )
        ...
        private var DeskMenuMaintenanceType = PermissionEntry(
            305,
            "Menú, tareas",
            PermissionCategory.DeskMenuAssetMaintenance
        )
        ...
        ////////////// PAGINAS ASSET MAINTENANCE
        private var DeskPageAssetMaintenance = PermissionEntry(
            350,
            "Página, mantenimiento",
            PermissionCategory.DeskPageAssetMaintenance
        )
        private var DeskPageAssetWithMaintenanceProgramed = PermissionEntry(
            351,
        ...
        private var DeskPageActionLogAssetMaintenance = PermissionEntry(
            353,
            "Página, registro de acciones",
            PermissionCategory.DeskPageAssetMaintenance
        )
        private var DeskPageImageControlAssetMaintenance = PermissionEntry(
            354,
            "Página, imágenes",
            PermissionCategory.DeskPageAssetMaintenance
        )
        ...
        fun getAll(): ArrayList<PermissionEntry> {
            ...
            allSections.addAll(getAllAssetControlMaintenanceDesktop())
            allSections.addAll(getAllAssetControlMaintenanceSpecial())
        ...
        private fun getAllAssetControlFunction(): ArrayList<PermissionEntry> {
            ...
            Collections.addAll(
                ...
                AddProvider,
                ModifyProvider,
                AddMaintenanceTypeGroup,
                ModifyMaintenanceTypeGroup,
                PrintLabel,
                PrintReport,
                AddAssetReview,
        ...
        private fun getAllAssetControlDeskMenu(): ArrayList<PermissionEntry> {
            ...
            Collections.addAll(
                ...
                DeskMenuAssetMaintenanceProgramed,
        ...
        private fun getAllAssetControlMaintenanceDesktop(): ArrayList<PermissionEntry> {
            val allSections = ArrayList<PermissionEntry>()
            allSections.addAll(getAllAssetControlMaintenanceFunction())
            allSections.addAll(getAllAssetControlMaintenanceDeskMenu())
            allSections.addAll(getAllAssetControlMaintenanceDeskPage())

            return ArrayList(allSections.sortedWith(compareBy { it.id }))
        }

        private fun getAllAssetControlMaintenanceFunction(): ArrayList<PermissionEntry> {
            val allSections = ArrayList<PermissionEntry>()
            Collections.addAll(
                allSections,
                AddRepairman,
        ...
        private fun getAllAssetControlMaintenanceDeskMenu(): ArrayList<PermissionEntry> {
            val allSections = ArrayList<PermissionEntry>()
            Collections.addAll(
                allSections,
                DeskMenuRepairman,
        ...
        private fun getAllAssetControlMaintenanceDeskPage(): ArrayList<PermissionEntry> {
            val allSections = ArrayList<PermissionEntry>()
            Collections.addAll(
                allSections,
                DeskPageAssetMaintenance,
                DeskPageAssetWithMaintenanceProgramed,
                DeskPageAssetOnRepairshop,
                DeskPageActionLogAssetMaintenance,
                DeskPageImageControlAssetMaintenance
            )

            return ArrayList(allSections.sortedWith(compareBy { it.id }))
        }

        private fun getAllAssetControlMaintenanceSpecial(): ArrayList<PermissionEntry> {
            val allSections = ArrayList<PermissionEntry>()
            Collections.addAll(
                allSections,
