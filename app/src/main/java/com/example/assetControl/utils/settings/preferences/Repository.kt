...
class Repository {
    companion object {
        ...
        val wsUrl: String //"https://dev.example.com/Milestone13/ac/s1/service.php"
            get() {
                return Preferences.prefsGetString(Preference.acWsServer)
            }

        val wsNamespace: String //"https://dev.example.com/Milestone13/ac/s1"
            get() {
                return Preferences.prefsGetString(Preference.acWsNamespace)
            }

        val urlPanel: String //"http://client.example.com:80/7RDRHHAH/panel"
            get() {
        ...
        val wsUrlCron: String //"https://dev.example.com/Milestone13/ac"
            get() {
                return wsNamespace.replace("/s1", "")
            }

        val wsMantUrl: String //"https://dev.example.com/Milestone13/ac/smant/service.php"
            get() {
                return Preferences.prefsGetString(Preference.acMantWsServer)
            }

        val wsMantNamespace: String //"https://dev.example.com/Milestone13/ac/smant"
            get() {
        ...
        val wsIcUrl: String //"https://dev.example.com/Milestone13/ic/s1/service.php"
            get() {
                return Preferences.prefsGetString(Preference.icWsServer)
            }

        val wsIcNamespace: String  //"https://dev.example.com/Milestone13/ic/s1"
            get() {
