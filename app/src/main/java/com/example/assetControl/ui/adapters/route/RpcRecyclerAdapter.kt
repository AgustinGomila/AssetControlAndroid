package com.example.assetControl.ui.adapters.route
...
import com.example.assetControl.databinding.RouteProcessContentRowBinding
...
class RpcRecyclerAdapter(
    ...
    companion object {
        ...
        private fun setupColors() {
            ...
            layoutProcessedForeColor =
                getBestContrastColor(getColor(context.resources, R.color.status_rpc_processed, null))
            layoutSkippedForeColor =
                getBestContrastColor(getColor(context.resources, R.color.status_rpc_skipped, null))
            layoutNotProcessedForeColor =
                getBestContrastColor(getColor(context.resources, R.color.status_rpc_not_processed, null))
    ...
    class SelectedViewHolder(val binding: RouteProcessContentRowBinding) : ViewHolder(binding.root) {
        ...
        fun setStyle(content: RouteProcessContent) {
            ...
            // Background layouts
            val layoutProcessed = getDrawable(context.resources, R.drawable.layout_rpc_processed, null)
            val layoutSkipped = getDrawable(context.resources, R.drawable.layout_rpc_skipped, null)
            val layoutNotProcessed = getDrawable(context.resources, R.drawable.layout_not_processed, null)
            val layoutDefault = getDrawable(context.resources, R.drawable.layout_rpc_default, null)
