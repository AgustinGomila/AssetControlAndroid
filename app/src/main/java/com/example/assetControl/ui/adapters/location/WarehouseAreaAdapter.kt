package com.example.assetControl.ui.adapters.location
...
class WarehouseAreaAdapter : ArrayAdapter<WarehouseArea>, Filterable {
    ...
    ) : super(AssetControlApp.context, resource, warehouseAreas) {
    ...
    ) : super(AssetControlApp.context, resource, suggestedList) {
        this.activity = activity
        this.resource = resource
        this.fullList = warehouseAreas
    ...
    private fun reportWarehouseAreaAdded(areas: ArrayList<WarehouseArea>) {
        ...
        res += ": " +
                if (areas.size > 1)
                    " ${AssetControlApp.context.getString(R.string.added_plural)}" else
                    " ${AssetControlApp.context.getString(R.string.added)}"
    ...
    private fun reportWarehouseAreaRemoved(areas: ArrayList<WarehouseArea>) {
        ...
        res += ": " +
                if (areas.size > 1)
                    " ${AssetControlApp.context.getString(R.string.removed_plural)}" else
                    " ${AssetControlApp.context.getString(R.string.removed)}"
