package com.example.assetControl.ui.adapters.asset
...
class AssetRecyclerAdapter private constructor(builder: Builder) :
    ...
    internal class SelectedViewHolder(val binding: AssetRowExpandedBinding) :
        ...
        private fun setStyle(asset: Asset) {
            ...
            val layoutOnInventory = getDrawable(context.resources, R.drawable.layout_thin_border_green, null)
            val layoutMissing = getDrawable(context.resources, R.drawable.layout_thin_border_red, null)
            val layoutRemoved = getDrawable(context.resources, R.drawable.layout_thin_border_yellow, null)
    ...
    companion object {
        ...
        private fun setupColors() {
            ...
            val onInventory = getColor(context.resources, R.color.status_on_inventory, null)
            val missing = getColor(context.resources, R.color.status_missing, null)
            val removed = getColor(context.resources, R.color.status_removed, null)
