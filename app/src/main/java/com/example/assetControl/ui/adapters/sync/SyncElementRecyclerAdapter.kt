package com.example.assetControl.ui.adapters.sync
...
import com.example.assetControl.databinding.NullRowBinding
import com.example.assetControl.databinding.SyncElementAssetReviewRowBinding
import com.example.assetControl.databinding.SyncElementAssetRowBinding
import com.example.assetControl.databinding.SyncElementDataCollectionRowBinding
import com.example.assetControl.databinding.SyncElementImageRowBinding
import com.example.assetControl.databinding.SyncElementItemCategoryRowBinding
import com.example.assetControl.databinding.SyncElementRouteProcessRowBinding
import com.example.assetControl.databinding.SyncElementWarehouseAreaRowBinding
import com.example.assetControl.databinding.SyncElementWarehouseMovementRowBinding
import com.example.assetControl.databinding.SyncElementWarehouseRowBinding
import com.example.assetControl.network.sync.SyncRegistryType
import com.example.assetControl.ui.adapters.interfaces.Interfaces.AlbumViewRequiredListener
import com.example.assetControl.ui.adapters.interfaces.Interfaces.CheckedChangedListener
import com.example.assetControl.ui.adapters.interfaces.Interfaces.DataSetChangedListener
...
class SyncElementRecyclerAdapter private constructor(builder: Builder) :
    ...
    internal class AssetViewHolder(val binding: SyncElementAssetRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_blue, null) ?: return
    ...
    internal class ItemCategoryViewHolder(val binding: SyncElementItemCategoryRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_green, null) ?: return
    ...
    internal class WarehouseViewHolder(val binding: SyncElementWarehouseRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_red, null) ?: return
    ...
    internal class DataCollectionViewHolder(val binding: SyncElementDataCollectionRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_violet2, null) ?: return
    ...
    internal class RouteProcessViewHolder(val binding: SyncElementRouteProcessRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_violet3, null) ?: return
    ...
    internal class WarehouseMovementViewHolder(val binding: SyncElementWarehouseMovementRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_yellow, null) ?: return
    ...
    internal class AssetReviewViewHolder(val binding: SyncElementAssetReviewRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            val v = itemView
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_yellow2, null) ?: return
    ...
    internal class ImageViewHolder(val binding: SyncElementImageRowBinding) :
        ...
        private fun setStyle(isSelected: Boolean) {
            ...
            // Background layouts
            val layout = getDrawable(context.resources, R.drawable.layout_thin_border_orange, null)
                ?: return
    ...
    companion object {
        ...
        private fun setupColors() {
            ...
            val asset = getColor(context.resources, R.color.sync_element_asset, null)
            val image = getColor(context.resources, R.color.sync_element_image, null)
            val itemCategory = getColor(context.resources, R.color.sync_element_item_category, null)
            val warehouse = getColor(context.resources, R.color.sync_element_warehouse, null)
            val warehouseArea = getColor(context.resources, R.color.sync_element_warehouse_area, null)
            val dataCollection = getColor(context.resources, R.color.sync_element_data_collection, null)
            val routeProcess = getColor(context.resources, R.color.sync_element_route_process, null)
            val warehouseMovement = getColor(context.resources, R.color.sync_element_warehouse_movement, null)
            val assetReview = getColor(context.resources, R.color.sync_element_asset_review, null)
