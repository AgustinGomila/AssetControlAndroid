package com.example.assetControl.ui.panel
...
import com.example.assetControl.utils.Statics.Companion.isDebuggable
import com.example.assetControl.utils.parcel.Parcelables.serializable
import com.example.assetControl.utils.parcel.Parcelables.serializableMap
...
class PanelController(
    ...
    private fun logDebug(message: String) {
        if (isDebuggable()) Log.d(this::class.java.simpleName, message)
    }
