...
import com.example.assetControl.data.room.repository.location.TempWarehouseAreaRepository
import com.example.assetControl.data.room.repository.location.WarehouseAreaRepository
import com.example.assetControl.databinding.WarehouseAreaPrintLabelActivityTopPanelCollapsedBinding
...
class WarehouseAreaPrintLabelActivity : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener,
    ...
    private fun loadDefaultValues() {
        ...
        val id = sr.prefsGetLong(Preference.defaultBarcodeLabelCustomWa)
