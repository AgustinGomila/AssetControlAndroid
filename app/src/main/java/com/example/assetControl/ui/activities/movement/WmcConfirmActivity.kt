...
import com.example.assetControl.databinding.WarehouseMovementContentConfirmActivityBottomPanelCollapsedBinding
...
class WmcConfirmActivity : AppCompatActivity(),
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelable("warehouseArea", headerFragment?.warehouseArea)
