package com.example.assetControl.ui.adapters.dataCollection
...
class DataCollectionRuleAdapter : ArrayAdapter<DataCollectionRule> {
    ...
    ) : super(AssetControlApp.context, resource, dcRules) {
        ...
        if (position >= 0) {
            ...
            if (dataCollectionRule != null) {
                ...
                val lightgray = ResourcesCompat.getColor(
                    AssetControlApp.context.resources, R.color.lightgray, null
                )
                val whitesmoke = ResourcesCompat.getColor(
                    AssetControlApp.context.resources, R.color.whitesmoke, null
                )

                // Font colors
                val black = ResourcesCompat.getColor(
                    AssetControlApp.context.resources, R.color.text_dark, null
                )
                val dimgray = ResourcesCompat.getColor(
                    AssetControlApp.context.resources, R.color.dimgray, null
                )
