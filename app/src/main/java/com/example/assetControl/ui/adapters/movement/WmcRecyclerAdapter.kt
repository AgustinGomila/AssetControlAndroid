package com.example.assetControl.ui.adapters.movement
...
class WmcRecyclerAdapter(
    ...
    companion object {
        ...
        private fun setupColors() {
            ...
            layoutToMoveForeColor = getBestContrastColor(getColor(context.resources, R.color.status_to_move, null))
            layoutNoNeedToMoveForeColor =
                getBestContrastColor(getColor(context.resources, R.color.status_no_need_to_move, null))
    ...
    class SelectedViewHolder(val binding: AssetRowExpandedBinding) : ViewHolder(binding.root) {
        ...
        fun setStyle(content: WarehouseMovementContent) {
            ...
            val layoutToMove = getDrawable(context.resources, R.drawable.layout_thin_border_green, null)
            val layoutNoNeedToMove = getDrawable(context.resources, R.drawable.layout_thin_border_yellow, null)
