package com.dacosys.assetControl.devices.jotter
...
import com.dacosys.assetControl.devices.scanners.Collector
import com.dacosys.assetControl.devices.scanners.Collector.Companion.collectorType
import com.dacosys.assetControl.devices.scanners.Collector.Companion.collectorTypeChanged
import com.dacosys.assetControl.devices.scanners.Collector.Companion.isNfcRequired
import com.dacosys.assetControl.devices.scanners.Scanner
import com.dacosys.assetControl.devices.scanners.Scanner.ScannerListener
import com.dacosys.assetControl.devices.scanners.collector.CollectorType
import com.dacosys.assetControl.devices.scanners.floatingCamera.FloatingCameraBarcode
import com.dacosys.assetControl.devices.scanners.nfc.Nfc
import com.dacosys.assetControl.devices.scanners.nfc.Nfc.enableNfcForegroundDispatch
...
import com.dacosys.assetControl.devices.scanners.rfid.RfidType
...
object ScannerManager : Jotter.Listener {
     ...
     * LifecycleOwner com.dacosys.assetcontrol.xxx.xxxActivity@cf72429
