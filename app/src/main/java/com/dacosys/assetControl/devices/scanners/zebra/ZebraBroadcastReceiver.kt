...
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_COMMAND
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_CONFIGURATION_UPDATE
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_NOTIFICATION_PROFILE_NAME
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_NOTIFICATION_STATUS
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_PROFILE_SWITCH
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_SCANNER_STATUS
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_RESULT
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_RESULT_GET_VERSION_INFO
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_RESULT_INFO
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_RESULT_NOTIFICATION
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_RESULT_NOTIFICATION_TYPE
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.activityIntentFilterAction
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.datawedgeIntentKeyData
