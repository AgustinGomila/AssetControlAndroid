package com.dacosys.assetControl.devices.scanners.honeywell
...
import com.dacosys.assetControl.devices.scanners.honeywell.Honeywell.Constants.PROPERTY_DATA_PROCESSOR_DATA_INTENT
...
class Honeywell(private val activity: AppCompatActivity) : Scanner() {
    ...
    internal object Constants {
        ...
        const val ACTION_BARCODE_DATA =
            "com.dacosys.assetControl.intent.action.BARCODE"
    ...
    private fun resumeScanner(): Boolean {
        ...
        try {
            ...
            val intent = Intent(Constants.ACTION_CLAIM_SCANNER)
                ...
                /*
                We are using "AssetControl", so a profile with this name has to be created in Scanner settings:
