package com.dacosys.assetControl.devices.scanners.zebra
...
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.ACTION_DATAWEDGE
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.ACTION_RESULT
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.ACTION_RESULT_NOTIFICATION
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_CREATE_PROFILE
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_EMPTY
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_GET_VERSION_INFO
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_APPLICATION_NAME
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_NOTIFICATION_TYPE
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_KEY_VALUE_SCANNER_STATUS
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_PROFILENAME
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_REGISTER_NOTIFICATION
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SEND_RESULT
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SET_CONFIG
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_SOFT_SCAN_TRIGGER
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.EXTRA_UNREGISTER_NOTIFICATION
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.activityActionFromService
import com.dacosys.assetControl.devices.scanners.zebra.Zebra.Constants.activityIntentFilterAction
