package com.dacosys.assetControl.ui.common.snackbar
...
data class SnackBarEventData(
    ...
    constructor(parcel: Parcel) : this(
        ...
        parcel.readParcelable(SnackBarType::class.java.classLoader, SnackBarType::class.java) ?: SnackBarType.INFO
    )
