...
abstract class AssetMaintenanceEntry {
    companion object {
...
class AssetMaintenance(
    ...
    @ColumnInfo(name = AssetMaintenanceEntry.ASSET_STR) var assetStr: String? = null,
    @ColumnInfo(name = AssetMaintenanceEntry.ASSET_CODE) var assetCode: String = "",
    @ColumnInfo(name = AssetMaintenanceEntry.MAINTENANCE_TYPE_STR) var maintenanceTypeStr: String? = null,
) : Parcelable {
