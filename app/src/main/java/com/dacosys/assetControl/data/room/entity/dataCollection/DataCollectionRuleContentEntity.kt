...
@Entity(
    tableName = DataCollectionRuleContentEntry.TABLE_NAME,
    indices = [
        Index(
            value = [DataCollectionRuleContentEntry.DATA_COLLECTION_RULE_ID],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.DATA_COLLECTION_RULE_ID}"
        ),
        Index(
            value = [DataCollectionRuleContentEntry.LEVEL],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.LEVEL}"
        ),
        Index(
            value = [DataCollectionRuleContentEntry.POSITION],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.POSITION}"
        ),
        Index(
            value = [DataCollectionRuleContentEntry.ATTRIBUTE_ID],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.ATTRIBUTE_ID}"
        ),
        Index(
            value = [DataCollectionRuleContentEntry.ATTRIBUTE_COMPOSITION_ID],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.ATTRIBUTE_COMPOSITION_ID}"
        ),
        Index(
            value = [DataCollectionRuleContentEntry.DESCRIPTION],
            name = "IDX_${DataCollectionRuleContentEntry.TABLE_NAME}_${DataCollectionRuleContentEntry.DESCRIPTION}"
        )
    ]
)
