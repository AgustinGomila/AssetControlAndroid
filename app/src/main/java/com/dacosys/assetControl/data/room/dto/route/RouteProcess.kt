...
abstract class RouteProcessEntry {
    companion object {
...
class RouteProcess(
    @ColumnInfo(name = RouteProcessEntry.ID) var id: Long = 0L,
    ...
    @ColumnInfo(name = RouteProcessEntry.ROUTE_STR) var routeStr: String? = null,
) : Parcelable {
