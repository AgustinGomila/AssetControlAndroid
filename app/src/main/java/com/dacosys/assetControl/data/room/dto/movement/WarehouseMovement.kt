...
abstract class WarehouseMovementEntry {
    companion object {
...
class WarehouseMovement(
    ...
    @ColumnInfo(name = WarehouseMovementEntry.ORIGIN_WAREHOUSE_STR) var origWarehouseStr: String? = null,
    @ColumnInfo(name = WarehouseMovementEntry.ORIGIN_WAREHOUSE_AREA_STR) var origWarehouseAreaStr: String? = null,
    @ColumnInfo(name = WarehouseMovementEntry.DESTINATION_WAREHOUSE_STR) var destWarehouseStr: String? = null,
    @ColumnInfo(name = WarehouseMovementEntry.DESTINATION_WAREHOUSE_AREA_STR) var destWarehouseAreaStr: String? = null,
) : Parcelable {
