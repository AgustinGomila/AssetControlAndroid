...
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.ASSET_CODE
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.ASSET_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.ASSET_STR
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.COLLECTOR_DATA_COLLECTION_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.COLLECTOR_ROUTE_PROCESS_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.COMPLETED
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.DATA_COLLECTION_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.DATE_END
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.DATE_START
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.TABLE_NAME
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.TRANSFERED_DATE
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.USER_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.WAREHOUSE_AREA_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.WAREHOUSE_AREA_STR
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.WAREHOUSE_ID
import com.dacosys.assetControl.dataBase.datacollection.DataCollectionContract.DataCollectionEntry.Companion.WAREHOUSE_STR
...
import com.dacosys.assetControl.dataBase.route.RouteProcessContract
...
class DataCollectionDbHelper {
    ...
    fun selectByNoTransferred(): ArrayList<DataCollection> {
        ...
        val specialLeftJoin =
            " LEFT OUTER JOIN " + rpEntry.TABLE_NAME + " ON " +
