package com.dacosys.assetControl.utils.scanners.nfc
...
object Nfc {
    ...
    fun setupNFCReader(targetActivity: AppCompatActivity?) {
        ...
        if (!mNfcAdapter!!.isEnabled) {
            Log.d(javaClass.simpleName, getContext().getString(R.string.NFC_is_disabled))
        } else {
            Log.d(javaClass.simpleName, getContext().getString(R.string.NFC_is_enabled))
        }
