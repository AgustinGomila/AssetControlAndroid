...
import com.dacosys.assetControl.ui.common.utils.Screen.Companion.getScreenHeight
import com.dacosys.assetControl.ui.common.utils.Screen.Companion.getScreenWidth
import com.dacosys.assetControl.ui.common.utils.Screen.Companion.getSystemBarsHeight
...
import com.dacosys.assetControl.utils.settings.preferences.Preferences.Companion.prefsPutInt
...
class FloatingCameraBarcode(private var activity: AppCompatActivity) : BarcodeCallback,
    ...
    private fun onCreate() {
        ...
        EasyFloat.with(activity).setTag(activityName).setShowPattern(ShowPattern.FOREGROUND)
            .setLocation(
        ...
        ivScale.onScaledListener = object : ScaleImage.OnScaledListener {
            override fun onScaled(x: Float, y: Float, event: MotionEvent) {
                ...
                EasyFloat.updateFloat(
                    activityName, width = params.width, height = params.height
                )
            }
        }
