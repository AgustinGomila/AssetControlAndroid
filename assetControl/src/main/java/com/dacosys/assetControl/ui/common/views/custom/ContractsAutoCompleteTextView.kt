package com.dacosys.assetControl.ui.common.views.custom
...
class ContractsAutoCompleteTextView : AppCompatAutoCompleteTextView {
    ...
    override fun onFilterComplete(count: Int) {
        ...
        if (onContractsAvailability != null) {
            (onContractsAvailability ?: return).contractsRetrieved(count)
        }
    }

    override fun dismissDropDown() {
        if (onContractsAvailability != null) {
            (onContractsAvailability ?: return).contractsRetrieved(0)
        }
