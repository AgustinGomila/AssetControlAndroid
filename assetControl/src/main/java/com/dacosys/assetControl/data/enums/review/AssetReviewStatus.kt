...
data class AssetReviewStatus(val id: Int, val description: String) : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<AssetReviewStatus> {
        ...
        var unknown = AssetReviewStatus(0, getContext().getString(R.string.review_status_unknown))
        var onProcess = AssetReviewStatus(1, getContext().getString(R.string.review_status_on_process))
        var completed = AssetReviewStatus(2, getContext().getString(R.string.review_status_completed))
        var transferred =
            AssetReviewStatus(3, getContext().getString(R.string.review_status_transferred))
