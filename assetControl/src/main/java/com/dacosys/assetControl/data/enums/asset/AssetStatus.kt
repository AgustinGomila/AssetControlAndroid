...
data class AssetStatus(val id: Int, val description: String) : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<AssetStatus> {
        ...
        val unknown = AssetStatus(0, getContext().getString(R.string.asset_status_unknown))
        var onInventory = AssetStatus(1, getContext().getString(R.string.asset_status_on_inventory))
        var removed = AssetStatus(2, getContext().getString(R.string.asset_status_removed))
        var missing = AssetStatus(3, getContext().getString(R.string.asset_status_missing))
