package com.dacosys.assetControl.model.assets.attributes.attribute.wsObject
...
constructor() {
    ...
    fun attributeGetAll(
        ...
        val any = Statics.getWebservice().s(methodName = "Attribute_GetAll")
    ...
    fun attributeModify(
        ...
        val aSoapObject = SoapObject(Statics.getWebservice().namespace, "attribute")
