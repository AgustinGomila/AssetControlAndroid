...
import com.dacosys.assetControl.model.assets.itemCategory.`object`.ItemCategoryCRUD.Companion.RC_ERROR_OBJECT_NULL
import com.dacosys.assetControl.model.assets.itemCategory.`object`.ItemCategoryCRUD.Companion.RC_ERROR_UPDATE
...
class ItemCategoryCRUDActivity : AppCompatActivity(),
    ...
    private fun changeItemCategory(tempItemCategory: ItemCategory) {
        if (itemCategory != null ||
            (itemCategoryCRUDFragment?.getDescription() ?: "").isNotEmpty()
        ) {
