package com.dacosys.assetControl.views.locations.warehouse.activities
...
import com.dacosys.assetControl.model.locations.warehouse.`object`.WarehouseCRUD.Companion.RC_ERROR_OBJECT_NULL
import com.dacosys.assetControl.model.locations.warehouse.`object`.WarehouseCRUD.Companion.RC_ERROR_UPDATE
...
class WarehouseCRUDActivity : AppCompatActivity(),
    ...
    private fun changeWarehouse(tempWarehouse: Warehouse) {
        if (warehouse != null ||
            (warehouseCRUDFragment?.getDescription() ?: "").isNotEmpty()
        ) {
