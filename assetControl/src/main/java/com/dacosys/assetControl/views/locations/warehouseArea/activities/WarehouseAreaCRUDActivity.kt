...
import com.dacosys.assetControl.model.locations.warehouseArea.`object`.WarehouseAreaCRUD.Companion.RC_ERROR_OBJECT_NULL
import com.dacosys.assetControl.model.locations.warehouseArea.`object`.WarehouseAreaCRUD.Companion.RC_ERROR_UPDATE
...
class WarehouseAreaCRUDActivity : AppCompatActivity(),
    ...
    private fun changeWarehouseArea(tempWarehouseArea: WarehouseArea) {
        if (warehouseArea != null ||
            (warehouseAreaCRUDFragment?.getDescription() ?: "").isNotEmpty()
        ) {
